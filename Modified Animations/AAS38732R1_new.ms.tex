...
ESIS is a Computed Tomography Imaging Spectrograph (CTIS) designed to \textbf{map emission line profiles across a wide field of view, revealing the structure and dynamics of}  
...
He\,{\sc i} & 584.33 & 0.70 \\
	...
	\end{table}
    	...
    	The octagonal field stop is \edit1{approximately} 5 mm wide, which is equivalent to 11.5\arcmin \  when projected onto the sky. 
...
\textbf{By the reasoning given above,} we immediately know that this event is predominantly blue shifted.  
    	...
    	\begin{figure}
    		\begin{center}
    		\begin{interactive}{animation}{f11.mp4}
    			\includegraphics{main_event_dif}
    		\end{interactive}
    			\caption{The largest and most complex velocity event (e) captured by ESIS shown at three different times. The event starts as two jets (one red, one blue) with slight spatial separation at location e1, evolves into a strong red shift where the event begins paired with faint blue shifted material above (e2), and ends in a complicated combination of velocity not easily interpreted from difference images. 
The animation of this figure shows the complete evolution of the event with co-temporal images from AIA 304\,\AA, 171\,\AA, and 193\,\AA\ for additional context. The animation begins at September 30th, 2019 at 18:06:16 and ends the same day at 18:10:56. The real-time duration of the animation is 6 seconds.  Snapshots of the AIA images are also included in Figure \ref{fig:main_event_aia}.}
    			}
