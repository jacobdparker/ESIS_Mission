...
%	        	{\includegraphics[]{otherx_invertb}};
%        	\end{tikzpicture}
    	\caption{MART inverted results for event d in Figure \ref{fig:l3_dif} presented in the same fashion as Figure \ref{fig:perfect_x_inverted}. Full evolution included in \MYhref{https://scholarworks.montana.edu/xmlui/handle/1/16535}{animation} (Appendix \ref{ani}).
    	}
