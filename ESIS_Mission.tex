...
\section{ESIS Mission}
	...
	\subsection{Pointing} \label{sec:point}
		...
		\begin{figure}[h!]
			\begin{center}
				\includegraphics[width=0.7\textwidth]{altevents.png}
...
\section{Data} 
    ...
    Level 2 data adds additional meta data to the Level 1 data, including a non-linear and wavelength dependent mapping from detector to field stop for use in inversions (work in progress) \rts{This actually kinda works right now} \jdp{Kinda? ;) Maybe we'll have an "in preparation to cite for this.}.
