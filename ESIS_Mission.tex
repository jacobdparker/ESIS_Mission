...
\section{Introduction}
    ...
    It is in the low transition region where the magnetic pressure begins dominate the plasma pressure. \amy{incomplete thought?} 
    ...
    The release of free magnetic energy in the low-$\beta$ plasma was implicated because these flows are much faster than the TR sound speed (e.g., $\approx50$\,km/s \jdp{check me on this, I am struggling with the derivation and finding inconsistent answers} for C\,\textsc{iv}, formed at $10^5$\,K).
...
In this section we provide an overview of the ESIS experiment as well as the time and conditions of the ESIS rocket launch and subsequent data collection.   
    ...
    % 	operated in frame-transfer mode. Details like this are in the instrument paper 
    	...
    	Assuming a log electron density of \SI[per-mode=symbol]{10}{\elementarycharge\per\cm^3} and a quiet sun DEM, combined with the Schmeltz 2012 abundance file \citep{schmelz2012}, Chianti \citep{ChiantiI,ChiantiX} predicts an intensity relative to \ov \ of 0.7, 0.13, 0.06, 0.37, 0.12, and 1 respectively.
    	The .37 relative intensity of the \mgxbright \ line includes a contribution from another O\,\textsc{iv} line within .04 angstroms.
    	While this paper focuses primariy on the dominant \ov \ spectral line, future work will be focused on measuring plasma veloity in at least the three dominate spectral lines, \hei, \mgxbright, and \ov.
	...
	\subsection{Launch and Data Collection} 
		...
		Twenty nine of these images were light frames, meaning the shutter door was open and the RLG was enabled. 
...
\section{Preliminary Results}
    ...
    \amy{I think you did a good job of decribing this event in the text.  You may want to add some arrows in the figure that you can refer to in the text for added clarity.}
    ...
    \subsection{Early Inversions} \label{sec:inversions}
    	...
    	For out preliminary inversions of \ov \  ESIS Level-3 data we used a Multiplicative Algebraic Reconstruction Technique (MART).
