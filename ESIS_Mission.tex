...
\section{Introduction}
    ...
    \jdp{Somewhere in these first two paragraphs we should expand and describe some more explosive event work.  }
    ...
    % 	operated in frame-transfer mode. Details like this are in the instrument paper 
        ...
        \begin{figure}[ht]
			\begin{center}
				...
				\caption{A modeled layout showing the orientation of each ESIS detector relative to the solar image at the octagonal fieldstop.  The location of the brightest wavelengths in the passband is shown on each detector.}
