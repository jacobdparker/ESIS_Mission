...
\section{Preliminary Results}
        ...
        \cck{This paragraph does not belong here. Perhaps in conclusions.}
    ...
    \subsection{Level 3 Difference Images} \label{sec:dif_images} 
    	...
    	It is for this reason that we developed a spatially co-aligned data product (the Level 3 data) %quickly 
