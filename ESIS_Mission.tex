...
\section{Introduction}
    ...
    Higher resolution observations from the Interface Region Imaging Spectrograph \citep[IRIS]{depontieu2014} have shown that Si\,{\sc iv} line profiles often show very bright line cores with broad wings and very non-gaussian, more triangular profiles.\jdp{need citations here, and again in conclusion I think}
...
\section{Discussion/Conclusions and Future Work}
	...
	Bulk velocities exceeding the sound speed in O\,\textsc{v} ($\approx$ 78\,km\,s$^{-1}$ at 225000K \jdp{double check})  are indicative of reconnection outflows \citep{innes1997}.  
	The bimodal profile suggests a very small reconnection region with little to no stationary emitting plasma, pointing away from a dominate tearing mode instability, and toward a Petschek type reconnection \citep{Innes2015}.
