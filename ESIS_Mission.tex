...
\section{Preliminary Results}
    ...
    \subsection{Level-3 Difference Images}
    	...
    	For example, the top panel of Figure \ref{fig:dif_events} shows a V-shaped event that is pointed downward in the difference between the Camera 2 and Camera 3 Level-3 image.
    	...
    	The most obvious of these is a much larger eruption near disk center, event 4 in Figure \ref{fig:main_event}.
